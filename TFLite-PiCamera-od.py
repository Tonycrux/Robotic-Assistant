...
parser.add_argument('--model', help='Provide the path to the TFLite file, default is models/model.tflite',
                    default='/home/pi/tensorflow/models/model1.tflite')
parser.add_argument('--labels', help='Provide the path to the Labels, default is models/labels.txt',
                    default='/home/pi/tensorflow/models/labels.txt')
    ...
    for i in range(len(scores)):
        if ((scores[i] > MIN_CONF_THRESH) and (scores[i] <= 1.0)):
            ...
            if object_name == "chair":
                ...
                os.system("espeak 'A chair is detected'")

            elif object_name == "mouse":
                print("computer mouse detected")
                os.system("espeak 'Computer mouse detected'")
            
            elif object_name == "cell phone":
                print("Phone detected")
                os.system("espeak 'A mobile phone is detected'")
